    ...
    local Retail_UIControls = {
        ...
        },
        {
            ...
            onUpdate = function(self)
                if ( nPlates:GetOption("ShowExecuteRange") ) then
                    self:Enable()
                else
                    self:Disable()
                end
        ...
        },
        {
            ...
            func = function(self)
                if ( self:GetChecked() ) then
                    ...
                    nPlates:ResetCVars("nameplateOverlapH", "nameplateOverlapV")
                end
            end
        },
        {
        ...
        },
        {
            ...
            func = function(self)
                if ( not self:GetChecked() ) then
                    ...
                    nPlates:ResetCVars("nameplateOtherTopInset", "nameplateOtherBottomInset")
                end
            end
        },
        {
